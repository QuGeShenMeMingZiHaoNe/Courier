...
public abstract class ChartGenerator extends JPanel
    ...
    public ChartGenerator()
        ...
        j.setFont(j.getFont().deriveFont(10.0f).deriveFont(Font.ITALIC));
        list.add(j);
...
*/
        ...
        chartPanel.setPreferredSize(new Dimension((int)(DEFAULT_CHART_HEIGHT * DEFAULT_CHART_PROPORTION), (int)(DEFAULT_CHART_HEIGHT)));
        }
    ...
    void resizeChart()
        ...
        chartPanel.setSize(new Dimension(d));
