...
public class BreadFirstSearch {
    ...
    BreadFirstSearch(Map map) {
        this.map = map;
    }

    // basic type
    public LinkedList<ExpressCentre> findShortestPath(ExpressCentre from, ExpressCentre to) {
        initPathSearch();
    ...
    public LinkedList<ExpressCentre> findShortestPath(ExpressCentre from, ExpressCentre to, LinkedList<ExpressCentre> avoids) {
        initPathSearch();
        LinkedList<ExpressCentre> path = new LinkedList<ExpressCentre>();
        path.add(from);
